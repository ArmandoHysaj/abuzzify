      ...
      <div className="blockchain-page">
        ...
        <div className="educational-content container">
          <p className="cp-text">
            ...
            cryptocurrencies like Bitcoin. It is essentially a distributed
            ledger that records transactions across multiple computers in a
          ...
          <div className="wrapper">
            <div className="description">
              ...
              <ul>
                ...
                <li>
                  <strong>Supply Chain Management:</strong> Tracking and
                  verifying the origins of goods.
                </li>
              </ul>
              {/* <p>
