...
<h5>Eligibility:</h5> By using Abuzzify, you confirm that you are at least 13 years old or have the permission of a parent or guardian to use this platform.
<h5>Account Responsibility:</h5>
 We do not require or create user accounts, so there is no responsibility on your part to manage any account information.
 <h5>Prohibited Activities:</h5>

 You agree not to engage in any illegal activities, use the site in a manner that could harm the platform, or misuse any content provided by Abuzzify.
...
<h5>User-Generated Content:</h5>
 ...
 As we do not host user-generated content, this section is not applicable.
<h5>Intellectual Property:</h5>
 
 All content on Abuzzify, including text, graphics, and logos, is the property of Abuzzify and is protected by intellectual property laws. You may not use any content without explicit permission.
...
<h5>Right to Terminate: </h5>

We reserve the right to suspend or terminate your access to Abuzzify at any time without notice for any reason, including if we believe you have violated these Terms.
<h5>User Obligations Upon Termination:</h5>

 If your access is terminated, any data stored on your local device will remain unaffected, but you will no longer be able to access the platform.
...
<h4>
 ...
 If you have any questions about these Terms, please contact me at: <strong>armandohysaj7@gmail.com</strong>
    </div>
    </div>
  );
}
