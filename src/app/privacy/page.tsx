...
Since we do not collect personal data, we do not use your information in any way. The only data stored is on your local device and is used solely to enhance your experience by allowing you to keep track of your selected cryptocurrencies.
<h4>4. Data Security</h4>


Because we do not collect or store any personal data on our servers, there is no risk of unauthorized access, alteration, or loss of your data on our part. The security of your data stored in your local storage depends on the security of your device.
<h4>5. User Rights</h4>

Since we do not collect or store any personal information, there are no specific user rights related to data access, correction, or deletion on our platform.
...
If you have any questions about this Privacy Policy, please contact me at: <strong>armandohysaj7@gmail.com</strong>
      </div>
    </div>
  );
}
